from lib.room.one_exit import STD
...
#     }
#     if (!player_ob or !player_ob.query_gender())
...
#     }
#     get_level(level);
#     if (next_level == 20 and call_other("room/quest_room", "count", 0))
#     return 1;
#     if (level == 0)
#     next_exp = exp;
...
# {
#     int qnumber;
#     if (num and (sscanf(num, "%d", qnumber) == 1))
