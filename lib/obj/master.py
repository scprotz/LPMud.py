 ...
 * 2. The game will enter multiuser mode, and enable log in.
 *
 ...
 * That means that all occurrences of such
 * manipulations below must be carefully guarded against calls from
...
# }
    ...
    def connect(self):    
        self.write("obj/master: Connect to player.c...")
        ob = self.clone_object("obj/player")
        self.write("\n")
        return ob
